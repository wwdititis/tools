...
// function CLEAR() {
//     CURRENTLINE = '';
//     let linAtual = document.querySelector(`#board ul[data-row='${history.length}']`);
//     let colAtual = currentRow.querySelector('li:last-child');
//     onKeyDown(BACKSPACE_KEY); 
...
$(document).on('click', '#goplay', function(){
  $('.goplay').show();
});
$(document).on('click', '.goplay', function(){
  $('.goplay').hide();
